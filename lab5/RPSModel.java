...
public class RPSModel {
	...
	public void playRound(String player) {
		if (player != RPSUtils.ROCK && player != RPSUtils.PAPER && player != RPSUtils.SCISSORS) {
			throw new IllegalArgumentException("Player does not equal rock, paper or scissors.");
		} else {
			this.player = player;
			roundsPlayed++;
		...
		if (this.player == RPSUtils.ROCK)
		{
			if (this.computer == RPSUtils.PAPER)
			{
				roundsWonByComputer++;
			} 
			else if (this.computer == RPSUtils.SCISSORS)
			{
				roundsWonByPlayer++;
			} 
			else
		...
		else if (this.player == RPSUtils.SCISSORS)
		{
			if (this.computer == RPSUtils.ROCK)
			{
				roundsWonByComputer++;
			} 
			else if (this.computer == RPSUtils.PAPER)
			{
				roundsWonByPlayer++;
			} 
			else
		...
		else if (this.player == RPSUtils.PAPER)
		{
			if (this.computer == RPSUtils.SCISSORS)
			{
				roundsWonByComputer++;
			} 
			else if (this.computer == RPSUtils.ROCK)
			{
				roundsWonByPlayer++;
			} 
			else
	 ...
	 */
	public boolean draw() {
		if ((player == RPSUtils.ROCK && this.computer == RPSUtils.ROCK)
				|| (player == RPSUtils.PAPER && this.computer == RPSUtils.PAPER)
				|| (player == RPSUtils.SCISSORS && this.computer == RPSUtils.SCISSORS)) {
			return true;
		} else {
			return false;
		}
	...
	public boolean computerWins() {
		if ((player == RPSUtils.ROCK && this.computer == RPSUtils.PAPER)
				|| (player == RPSUtils.PAPER && this.computer == RPSUtils.SCISSORS)
				|| (player == RPSUtils.SCISSORS && this.computer == RPSUtils.ROCK)) {
			return true;
		} else {
			return false;
		}
	...
	public boolean playerWins() {
		if ((player == RPSUtils.ROCK && this.computer == RPSUtils.SCISSORS)
				|| (player == RPSUtils.PAPER && this.computer == RPSUtils.ROCK)
				|| (player == RPSUtils.SCISSORS && this.computer == RPSUtils.PAPER)) {
			return true;
		} else {
			return false;
		}
